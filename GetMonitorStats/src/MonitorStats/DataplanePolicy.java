...
public class DataplanePolicy {
	...
	public static String getJSONString() {
		...
		try {
			...
			oracle = new URL(
					ConfigReader.getControllerURL()+"/restconf/config/opendaylight-inventory:nodes/node/vRouter-R1/yang-ext:mount/vyatta-interfaces:interfaces/vyatta-interfaces-dataplane:dataplane/"
							+ConfigReader.getDataplaneName()+"/");
